...
const PoliceProfile = () => {
  ...
  const hasProfileImage = user?.userImage;
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 p-4 md:p-8">
      <div className="max-w-6xl mx-auto">
        <header className="mb-8">
          <h1 className="text-3xl md:text-4xl font-bold text-gray-900">Police Profile</h1>
          <p className="text-gray-600 mt-2">Manage your police account information</p>
        </header>
            ...
            <Card className="shadow-lg border-gray-200">
              <CardContent className="p-6">
                <div className="flex flex-col items-center text-center mb-6">
                  <div className="relative mb-4">
                    {hasProfileImage ? (
                      <div className="w-24 h-24 rounded-full overflow-hidden border-4 border-white shadow-lg mb-4">
                        <img 
                          src={`${import.meta.env.VITE_SERVER_URL}/${user.userImage}`} 
                          alt="Profile" 
                          className="w-full h-full object-cover"
                        />
                      </div>
                    ) : (
                      <div className="w-24 h-24 rounded-full bg-gradient-to-r from-blue-600 to-blue-800 flex items-center justify-center shadow-lg mb-4">
                  ...
                  <h2 className="text-2xl font-bold text-gray-900">{user?.userName || 'Police Officer'}</h2>
                  <div className="inline-flex items-center gap-2 mt-1 px-3 py-1 rounded-full bg-blue-600 text-white text-sm font-medium">
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-gray-900 bg-gray-50 p-3 rounded-lg">{user?.email || 'police@example.com'}</p>
                  ...
                  {hasPhoneNumber ? (
                    <p className="text-gray-900 bg-gray-50 p-3 rounded-lg">{user.phoneNumber}</p>
                  ) : (
          ...
          <div className="lg:w-2/3 space-y-8">
            <Card className="shadow-lg border-gray-200">
              <CardHeader className="pb-4">
                ...
                <CardDescription>
                  Your assigned station and jurisdiction
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="cursor-pointer hover:shadow-sm transition-shadow">
                    ...
                    <div className="flex items-center gap-3 p-4 bg-blue-50 rounded-lg border border-blue-100 hover:bg-blue-100 transition-colors">
                      ...
                      <span className="text-gray-900 font-medium">{user?.province || 'Not set'}</span>
                    </div>
                  </div>
                  ...
                  <div className="cursor-pointer hover:shadow-sm transition-shadow">
                    ...
                    <div className="flex items-center gap-3 p-4 bg-green-50 rounded-lg border border-green-100 hover:bg-green-100 transition-colors">
                      ...
                      <span className="text-gray-900 font-medium">{user?.district || 'Not set'}</span>
                    </div>
                  </div>
                </div>
              </CardContent>
                  ...
                  <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl p-6 border border-blue-200 cursor-pointer hover:shadow-md transition-all hover:-translate-y-1">
                    <div className="flex items-center justify-between mb-4">
                      <div className="p-3 bg-blue-200 rounded-lg">
                        <Badge className="h-6 w-6 text-blue-700" />
                      </div>
                      <span className="text-3xl font-bold text-blue-900">
                        {user?.policeData?.policeId || 'N/A'}
                      </span>
                    </div>
                    <h4 className="text-gray-600 font-medium">Police ID</h4>
                    <p className="text-gray-500 text-sm mt-1">Official ID Number</p>
                  </div>

                  <div className="bg-gradient-to-br from-indigo-50 to-indigo-100 rounded-xl p-6 border border-indigo-200 cursor-pointer hover:shadow-md transition-all hover:-translate-y-1">
                    <div className="flex items-center justify-between mb-4">
                      <div className="p-3 bg-indigo-200 rounded-lg">
                        <Star className="h-6 w-6 text-indigo-700" />
                      </div>
                      <span className="text-3xl font-bold text-indigo-900">
                        {user?.policeData?.rank || 'N/A'}
                      </span>
                    </div>
                    <h4 className="text-gray-600 font-medium">Rank</h4>
                    <p className="text-gray-500 text-sm mt-1">Police Rank</p>
                  </div>

                  <div className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-xl p-6 border border-purple-200 cursor-pointer hover:shadow-md transition-all hover:-translate-y-1">
                    <div className="flex items-center justify-between mb-4">
                      <div className="p-3 bg-purple-200 rounded-lg">
                        <Building className="h-6 w-6 text-purple-700" />
                      </div>
                      <span className="text-3xl font-bold text-purple-900">
                        {user?.policeData?.station || 'N/A'}
                      </span>
                    </div>
                    <h4 className="text-gray-600 font-medium">Station</h4>
                    <p className="text-gray-500 text-sm mt-1">Assigned Police Station</p>
                  </div>
                </div>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <Button 
                onClick={() => navigate("/policedashboard")} 
                className="h-12 gap-3 cursor-pointer"
              >
